  ...
  return <AccountLayout active="saved">
    <section className="account-card saved-section">
      ...
      <div className="saved-list">
        <Link href="/post/1" className="saved-item"><div className="saved-vote"><ArrowUp size={15}/><strong>248</strong></div><div className="saved-copy"><div className="saved-meta"><span className="tag-chip tag-next">#nextjs</span><span>AvoTalent · hace 2h</span></div><h2>Next.js 16: lo que realmente cambia para tu próximo proyecto</h2><p>Un recorrido práctico por Cache Components, React Compiler y las nuevas APIs que ya puedes usar.</p><div className="saved-footer"><span><MessageCircle size={14}/> 38 comentarios</span><span><Clock3 size={14}/> 8 min de lectura</span></div></div><MoreHorizontal size={18} className="saved-more"/></Link>
