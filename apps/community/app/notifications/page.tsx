  ...
  return <AccountLayout active="notifications">
    <section className="account-card notifications-section">
      ...
      <div className="notification-list">
        ...
        <Link href="/post/1" className="notification-item unread"><div className="notification-icon vote"><ArrowUp size={17}/></div><div><strong>Tu publicación recibió 8 votos nuevos</strong><p>La comunidad está encontrando útil tu explicación.</p><span className="muted">Hace 1 hora · AvoTalent</span></div><i/></Link>
